...
# Academic pictures
# Seeing Rafflesia (Photos by Deki Andriki)
<div style="margin-bottom:24px;">
  <img src="{{ '/gallery/academic/Rafflesia.jpeg' | relative_url }}" 
       alt="Academic image 1" 
       style="width:100%; height:auto; display:block; border-radius:8px;">
  <img src="{{ '/gallery/academic/Rafflesia2.jpeg' | relative_url }}" alt="Academic image 2" style="width:100%; height:auto; display:block;">
  <div style="margin-top:8px; font-size:0.95em; color:#555;">
    Rafflesia Arnoldi is the largest flower in the world. I was fortunate to see it in Bengkulu (Indonesia).
  </div>
</div>
...
<div style="margin-bottom:24px;">
<img src="{{ '/gallery/academic/SMB2025.jpeg' | relative_url }}" alt="APS 2026 (Denver,CO)" style="width:100%; height:auto; display:block;">
  <div style="margin-top:8px; font-size:0.95em; color:#555;">
    Presenting my research to the Society of Mathematical Biology (Edmonton, Canada).
  </div>
</div>
